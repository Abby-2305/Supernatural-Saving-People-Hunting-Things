...
EasyBox = Box(Leaderboard, width = int(LeaderboardWidth/3), height="fill", align = "left")
...
EasyBoxStats = Box(EasyBox, width = int(LeaderboardWidth/3), height="fill", align = "right")
for row in rows:
    EasyText = Text(EasyBoxStats, text = row)
    EasyText.text_size = int(LeaderboardHeight/30)
    EasyText.text_color = White

MediumBox = Box(Leaderboard, width = int(LeaderboardWidth/3), height="fill", align = "left")
...
MediumBoxStats = Box(MediumBox, width = int(LeaderboardWidth/3), height="fill", align = "right")
for row in rows:
...
HardBox = Box(Leaderboard, width = int(LeaderboardWidth/3), height = "fill", align = "left")
...
HardBoxStats = Box(HardBox, width = int(LeaderboardWidth/3), height = "fill", align = "right")
for row in rows:
...
button = PushButton(ExitBox, text ="QUIT", align = "left",  command = BackToMain)
