...
EasyBoxNumbers = Box(EasyBox, width = int(LeaderboardWidth/4), height="fill", align = "left")
for i in range (1,11):
...
EasyBoxStats = Box(EasyBox, width = int(LeaderboardWidth/4), height="fill", align = "left")
for row in rows:
