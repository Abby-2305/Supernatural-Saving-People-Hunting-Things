...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,a,b,enemyspeed, image):
        super().__init__()
...
while not gameExit:
    ...
    if EnemyCount>0:
        ...
        if enemyChoice == 1:
            enemy = Enemy(infoObject.current_w, (infoObject.current_h*(107/144))-50,30,50,10, "spr_ghost.png")
        if enemyChoice == 2:
            enemy = Enemy(infoObject.current_w, (infoObject.current_h*(107/144))-70,30,70,10, "spr_death.png")
